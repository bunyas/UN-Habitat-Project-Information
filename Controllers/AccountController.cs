...
namespace RecordKeeping.Controllers
{
    ...
    {
        UNHabitat_ProjectsEntities db = new UNHabitat_ProjectsEntities();
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (Request["districtList"] != null && Request["districtList"] != string.Empty)
                {
                    string mydistrict = Request["districtList"].ToString();
                    model.Project = System.Convert.ToInt32(mydistrict);// Request["usersList"].ToString();
                }


                var user = new ApplicationUser { UserName = model.Email, Email = model.Email, PhoneNumber = model.PhoneNumber, Project = model.Project };
